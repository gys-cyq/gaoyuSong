...
// 			}
// 		} else {
//             var index = $('.layui-bg-black #nav li').index($(this));
//             // var response=localStorage.getItem("response");
//             console.log(response)
//             var id = localStorage.getItem("id");
//             var title = localStorage.getItem("title");
//             var index2=$(this).children().index();
//
//             // var url='pages'+response[0].url+'.html';
// 			var url='../../pages/menu/menu.html';
//             alert(index2+'\n'+url)
//                 $.ajax({
